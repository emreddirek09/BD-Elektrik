            ...
            <div class="col-lg-6">
                <div class="card">
                    ...
                    <div class="card-body card-block">
                        ...
                        <div class="col col-sm-9">
                            <input type="text" id="TextParagraf1" runat="server" class="form-control">
                        </div>
                        <div class="col col-sm-3">
                            <label class=" form-control-label">2. Paragraf</label>
                        </div>
                        <div class="col col-sm-9">
                            <input type="text" id="TextParagraf2" runat="server" class="form-control">
                        </div>
                        ...
                        <div class="col col-sm-9">
                            <input type="text" id="TextSöz1" runat="server" class="form-control">
                        </div>
                        <div class="col col-sm-3">
                            <label class=" form-control-label">Özlü Söz 2</label>
                        </div>
                        <div class="col col-sm-9">
                            <input type="text" id="TextSöz2" runat="server" class="form-control">
                        </div>
